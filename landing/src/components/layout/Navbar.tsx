    ...
    <nav className="fixed top-0 w-full z-50 border-b border-white/5 bg-dark/60 backdrop-blur-xl">
      <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          <Link href="https://github.com/Adithya-Balan/AgentRank" className="text-sm font-medium text-white bg-white/10 hover:bg-white/20 px-4 py-2 rounded-full transition-colors flex items-center gap-2">

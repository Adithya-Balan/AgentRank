    ...
    <section id="ecosystem" className="bg-[#0a0a0a] border-y border-white/5 py-32 mt-24 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          {QUERIES.map((query, i) => (
            <FadeIn key={i} delay={0.1 * i} className={`rounded-2xl border p-8 flex flex-col h-full transition-all duration-300 ${activeQueryIndex === i ? 'bg-[#111111] border-accent/30 shadow-[0_0_30px_rgba(23,232,104,0.05)]' : 'bg-dark border-white/5 hover:border-white/10 shadow-2xl'}`}>
              <div className="mb-8">
                <query.icon className={`w-6 h-6 mb-5 ${activeQueryIndex === i ? 'text-accent' : 'text-gray-500'}`} />
                <p className={`text-sm font-mono ${activeQueryIndex === i ? 'text-white' : 'text-gray-400'}`}>
                  &quot;{query.title}&quot;
                </p>
              ...
              <div className="mt-auto pt-6 border-t border-white/5 min-h-[220px] flex flex-col justify-end">
                {activeQueryIndex !== i ? (
                  ...
                  <div className="animate-in fade-in zoom-in-95 duration-500">
                    ...
                    <div className="bg-dark border border-white/5 p-3 rounded-lg text-xs text-gray-400 leading-relaxed font-mono relative overflow-hidden">
